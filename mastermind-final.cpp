...
int main() {
	...
	do {
		...
		//oh god, 2 **actually 3 - or was it?** years... Now I know how horrible that was, I never liked it even at the start, but I had no idea how to get around it so I created this monstrosity
